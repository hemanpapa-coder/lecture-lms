...
import { FileText, Music, Video, Image as ImageIcon, Paperclip, ExternalLink, RotateCw } from 'lucide-react'
    ...
    return (
        <div className="rounded-2xl overflow-hidden border border-neutral-700 bg-neutral-900 flex items-center justify-center min-h-[40vh] max-h-[65vh] relative group">
            <button
                ...
                className="absolute top-4 right-4 p-2 bg-black/60 rounded-full text-white hover:bg-rose-500 transition md:opacity-0 md:group-hover:opacity-100 shadow-md backdrop-blur-sm z-10"
                title="사진 회전"
            >
