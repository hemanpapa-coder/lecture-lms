                ...
                <div className="mx-auto max-w-6xl space-y-8">
                    ...
                    <header className="flex flex-col sm:flex-row items-start sm:items-center justify-between rounded-3xl bg-white p-8 shadow-sm dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 mt-6 sm:mt-0">
                            <Link href={`/archive?course=${course.id}${viewMode === 'student' ? '&view=student' : ''}`} className="px-5 py-2.5 text-sm font-bold bg-emerald-50 text-emerald-700 hover:bg-emerald-100 dark:bg-emerald-900/30 dark:text-emerald-400 dark:hover:bg-emerald-900/50 rounded-xl transition flex items-center justify-center gap-2 shadow-sm border border-emerald-200 dark:border-emerald-800/50 w-full sm:w-auto">
