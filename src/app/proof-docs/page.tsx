...
export default async function ProofDocsPage() {
        ...
        <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 p-8">
            <div className="mx-auto max-w-3xl space-y-8">
                ...
                <div className="rounded-3xl bg-white p-8 shadow-sm border border-neutral-200/60 dark:bg-neutral-900 dark:border-neutral-800 text-center">
                    ...
                    <form action="/api/upload" method="POST" encType="multipart/form-data" className="max-w-md mx-auto text-left space-y-6">
                        ...
                        <button type="submit" className="w-full rounded-xl bg-blue-600 px-4 py-3 text-white font-bold hover:bg-blue-700 transition shadow-sm hover:shadow-md">
                            보안 서버로 제출
                        </button>
                    </form>
